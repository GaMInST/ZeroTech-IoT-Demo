...
public class IndividualDeviceControlActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_individual_device_control);
    ...
    private void initView() {
        ...
        adapter.setOnItemClickListener(new SimpleDevListAdapter.OnItemClickListener() {
            ...
            public void onItemClick(DeviceBean item, int position) {
                ...
                // Launch individual device control panel
                if (panelCallerService != null) {
                    panelCallerService.goPanelWithCheckAndTip(IndividualDeviceControlActivity.this, devId);
                } else {
                    Toast.makeText(IndividualDeviceControlActivity.this, "Panel service not available",
        ...
        ThingHomeSdk.newHomeInstance(familyService.getCurrentHomeId()).getHomeDetail(new IThingHomeResultCallback() {
            ...
            public void onError(String code, String error) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(IndividualDeviceControlActivity.this,
    ...
    public static void goControl(Activity activity) {
        Intent intent = new Intent(activity, IndividualDeviceControlActivity.class);
