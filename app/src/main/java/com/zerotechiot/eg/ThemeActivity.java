...
public class ThemeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sb.append("tab栏选中颜色(Tab Bar Selected Color): ").append(Integer.toHexString(manager.getTabBarSelectedColor()))
                .append("\n");
        sb.append("背景色(Background color): ").append(Integer.toHexString(manager.getBackgroundColor())).append("\n");
        sb.append("导航栏背景色(Navigator Background color): ").append(Integer.toHexString(manager.getNavigatorBgColor()))
                .append("\n");
        sb.append("底部Tab栏背景色(Bottom Tab Bar Background color): ")
                .append(Integer.toHexString(manager.getBottomTabBarBgColor())).append("\n");
        sb.append("卡片背景色(Card Background color): ").append(Integer.toHexString(manager.getCardBgColor())).append("\n");
        sb.append("弹窗内容背景色(Alert Background color): ").append(Integer.toHexString(manager.getAlertBgColor()))
                .append("\n");
        sb.append("弹窗蒙层色(Alert Mask color): ").append(Integer.toHexString(manager.getAlertMaskColor())).append("\n");
        sb.append("列表单元格背景颜色(List Cell Background color): ").append(Integer.toHexString(manager.getListCellBgColor()))
                .append("\n");
