package com.thingclips.smart.bizbundle.location;
...
public class LocationActivity extends AppCompatActivity {
    ...
    public static boolean checkGeoLocationPermission(Context context) {
        ...
        boolean gpsProvider = locationManager != null && locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER);
